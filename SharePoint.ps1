<#
    SharePoint Online PowerShell
        microsoft.online.sharepoint.powershell.16.0.20212.12000.nupkg
        from 
            https://www.powershellgallery.com/packages/Microsoft.Online.SharePoint.PowerShell/16.0.20212.12000
        extracted to 
           \WindowsPowerShell\Modules\microsoft.online.sharepoint.powershell.16.0.20212.12000

        Microsoft.Online.SharePoint.PowerShell.psd1



#>

Import-Module "\\ain2\dfsroot\USERDATA38\TADDED\Data\WindowsPowerShell\Modules\microsoft.online.sharepoint.powershell.16.0.20212.12000\Microsoft.Online.SharePoint.PowerShell.psd1" -Verbose
$Credential = Get-Credential -Message "Resource for M365"
Connect-SPOService -Url "https://falconcrossing-admin.sharepoint.com/" -Credential $Credential -Verbose

Get-SPOSite | Select-Object * | Out-GridView
